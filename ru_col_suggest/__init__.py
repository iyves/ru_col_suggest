...
# classes and use them.  If you change the name of `ru_col_suggest`, you'll also need to change it in
# the same way in the .allennlp_plugins file.
from ru_col_suggest.model import *
from ru_col_suggest.dataset_reader import *
